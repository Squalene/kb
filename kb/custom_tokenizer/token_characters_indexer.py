...
class TokenCharactersIndexer(TokenIndexer[List[int]]):
    ...
    def __init__(self,
        ...
        print("TokenCharactersIndexer params:",namespace,character_tokenizer,start_tokens,end_tokens,min_padding_length)
        #print("CharacterTokenizer fields",character_tokenizer._byte_encoding,character_tokenizer._lowercase_characters, character_tokenizer._start_tokens, character_tokenizer._end_tokens)
